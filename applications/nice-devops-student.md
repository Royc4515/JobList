...
## Stack Required
CI/CD, AWS, Azure, Python, Docker, REST APIs, GenAI/LLM tooling (AWS Bedrock, SageMaker, Azure AI — advantage)

## Tech Gap
DevOps/Cloud תעשייתי: אין ניסיון מעשי ב-CI/CD, AWS/Azure או Docker מעבר לחשיפה נקודתית. Python חזק ומושגי AI בסיסיים מכוסים; הפער המרכזי הוא תשתיות ענן ואוטומציה, לא תכנות.

## Red Flags
תפקיד DevOps/Infrastructure ולא Full-Stack/AI טהור. דורש AWS + Docker + CI/CD שאינם בפורטפוליו — סף כניסה טכני שדורש הדגשת יכולת self-learning. תנאי סף: 1.5-2 שנות לימוד שנותרו (מתקיים).

## Keywords Optimized
Python, CI/CD, AWS, Docker, REST APIs, AI/LLM concepts, Self-learner, English communication, Data Structures (93), Command Experience (Gaza Division)
